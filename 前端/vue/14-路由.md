...
**在一些不打算留历史记录的页面，需要开启，不让他前进后退**

开启**disable-devtool，RouterLink 使用 replace**
...
目前发现最好的方式了，还能解决参数过大问题，导致url过长的问题
...
是目前发现最好用的，数据页也响应式的，还能隐藏参数，但需求好像大都不需要响应式需要注意
